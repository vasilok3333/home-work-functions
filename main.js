...
1. В стрілкових функціях немає свого this, arguments, super, ;
2. Стрілкові функції не можуть бути викликані через new, тобто не можуть виступати конструктором;
3. Інший синтаксис оголошення;
4. В стрілкових функція є неявний return. 
